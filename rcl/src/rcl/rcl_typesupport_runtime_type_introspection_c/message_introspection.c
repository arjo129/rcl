...
rcl_get_runtime_type_message_typesupport_handle_with_deferred_desc(
  const char * serialization_lib_name)
{
  return rmw_get_runtime_type_message_typesupport_handle_with_deferred_desc(
...
RCL_WARN_UNUSED
rosidl_message_type_support_t *
rcl_get_runtime_type_message_typesupport_handle_with_desc(
  const char * serialization_lib_name,
  type_description_t * desc)
{
  return rmw_get_runtime_type_message_typesupport_handle_with_desc(
    rmw_get_serialization_support(serialization_lib_name),
    desc,
    rmw_feature_supported(RMW_MIDDLEWARE_SUPPORTS_TYPE_DISCOVERY),
    rmw_feature_supported(RMW_MIDDLEWARE_CAN_TAKE_DYNAMIC_DATA)
